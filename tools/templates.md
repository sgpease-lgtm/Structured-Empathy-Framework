...
This section includes templates that can be used for activities, illustrating discussions, or personal development. This will grow in time, and is a great oppourtunity for people to provide examples and samples from their own work in this domain.
...
- [Daniel Thomason](https://github.com/danielthomason/daniel-thomason/blob/master/Personal%20User%20Manual.md)
- [Lisette Sutherland](https://lisettesutherland.com/personal-user-manual-of-lisette-sutherland/)
- [René van Osnabrugge](https://github.com/renevanosnabrugge/renevanosnabrugge/blob/main/README.md)
- [Matt MacInnis](https://docs.google.com/document/d/1Qa6vPaeOHibIUiAUT6M0xWWPCMIVo91MWM7Kdchr7Jg/edit?tab=t.0#heading=h.tqufcljcvh7s)
- [Steven Sampson-Jones](https://medium.com/@stevensampsonjones/manual-of-steve-29cd95a9689d) - Visual rather than text document.
