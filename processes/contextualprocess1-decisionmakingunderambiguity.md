...
1. **Clarify what is known**  
   Identify facts, constraints, and non‑negotiables.
2. **Name what is unclear**  
   Surface gaps, uncertainties, and assumptions.
3. **Explore options collaboratively**  
   Generate possibilities without premature judgement.
4. **Frame risks explicitly**  
   Identify potential impacts, mitigations, and trade‑offs.
5. **Agree the rationale**  
   Document why this decision is being made now.
